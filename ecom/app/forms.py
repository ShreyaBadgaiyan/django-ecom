...
class CustomerRegistrationForm(UserCreationForm):
    ...
    #data of login form doesn't store anywhere 
...
class CustomerPasswordChangeForm(PasswordChangeForm):
    ...
    {'autocomplete':'current-password','class':'form-control','autofocus':True})
   )
...
class CustomerPasswordResetConfirmForm(SetPasswordForm):
    new_password1=forms.CharField(label=_("New Password"),
    strip=False,widget=forms.PasswordInput(attrs=
    {'autocomplete':'new-password','class':'form-control'}),
    help_text=password_validation.password_validators_help_text_html()
